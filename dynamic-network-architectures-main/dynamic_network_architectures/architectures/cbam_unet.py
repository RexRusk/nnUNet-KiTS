...
class CBAMPlainConvUNet(nn.Module):
    def __init__(self,
        ...
        self.encoder = CBAMPlainConvEncoder(input_channels, n_stages, features_per_stage, conv_op, kernel_sizes,
                                            strides,
...
if __name__ == '__main__':
    ...
    # add parameters here
    model = CBAMPlainConvUNet(4, 6, (32, 64, 125, 256, 320, 320), nn.Conv3d, 3, (1, 2, 2, 2, 2, 2), (2, 2, 2, 2, 2, 2), 4,
                          (2, 2, 2, 2, 2), False, nn.BatchNorm3d, None, None, None, None, None)
