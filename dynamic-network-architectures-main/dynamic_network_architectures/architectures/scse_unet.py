...
class SCSEPlainConvUNet(nn.Module):
    def __init__(self,
        ...
        self.encoder = SCSEPlainConvEncoder(input_channels, n_stages, features_per_stage, conv_op, kernel_sizes,
                                            strides,
    ...
    def __init__(self, conv_op, in_channels, reduction=16):
        ...
        self.cSE = nn.Sequential(
            ...
            nn.Conv2d(in_channels, in_channels // reduction,
                      1) if conv_op == torch.nn.modules.conv.Conv2d else nn.Conv3d(in_channels,
                                                                                   in_channels // reduction, 1),
